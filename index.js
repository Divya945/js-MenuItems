...
function displaymenuItems() {
  let itemSections = menu.map(function (items) {
  ...
  itemSections = itemSections.join(' ');
  itemSection.innerHTML = itemSections;
}
window.load = displaymenuItems();
...
filterBtn.forEach(function (btn) {
  ...
  btn.addEventListener('click', function (e) {
    ...
    const menuItemcategory = menu.filter(function (menuitem) {
